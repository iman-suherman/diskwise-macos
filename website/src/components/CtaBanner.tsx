...
export function CtaBanner() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 pb-6 sm:px-6 sm:pb-8">
      <div className="rounded-2xl bg-gradient-to-r from-brand-blue via-brand-blueDark to-brand-charcoal px-5 py-6 text-white shadow-card ring-1 ring-white/10 sm:rounded-[2rem] sm:px-8 sm:py-8 md:px-10">
